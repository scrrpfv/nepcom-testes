  ...
  return (
    <div className='font-roboto'>
      ...
      <main className='px-[20px] py-[60px]'>
        <h1 className='font-semibold text-size-[4rem]'>Sobre o NUPCOM</h1>
        <p className='mt-[20px]'>Somos a NEPCOM — uma equipe formada por estudantes de graduação do Centro de Informática da UFPE (CIn), movidos pela paixão por tecnologia, inovação e impacto real. Atuamos nas áreas de desenvolvimento de software, freelancing e soluções tecnológicas personalizadas, sempre buscando conectar teoria e prática em projetos desafiadores.<br /><br /> 
